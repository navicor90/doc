...
\subsubsection{Descripción de la funcionalidad} % ya se dijo en el sprint
\paragraph{Cargar análisis}
...
\paragraph{Generación de tablas y gráficas de mediciones}
...
Se requiere la preparación de datos para popular las tablas que guardan los datos de los objetos de las siguientes clases, \textbf{[Figura \ref{clases-doc-prog}]}.
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=1\textwidth]{img/dc_mediciones}
...
\subsubsection{Técnicas de programación utilizadas}
...
\subsubsection{Entorno, herramientas y tecnologías utilizadas}
...
\subsubsection{Especificación de recursos de la API}
