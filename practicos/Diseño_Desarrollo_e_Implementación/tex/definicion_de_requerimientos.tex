...
\begin{sidewaysfigure}
  \centering
  \includegraphics[width=0.8\textwidth]{img/tp1/modeloGrande}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{img/tp1/hl7}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{img/tp1/modgenfinal}
...
A continuación se detallarán los procesos que se encuentran representado en el diagrama de Flujo de datos de la \textbf{Figura \ref{hv_data_flow}}.
	...
	\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/hv_flujo_de_datos}
...
\item \textbf{Gestión de datos referidos a la salud}:
	...
	\end{itemize}
 	...
 	\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-carga_peso}
	...
	\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-carga_comidas}
...
\item \textbf{Gestión de los miembros del grupo familiar}: Éste es un aspecto bastante natural y necesario en los PHR, ya que en muchos casos un miembro del grupo familiar, gestiona información del resto, como es en el caso de los padres sobre los hijos. El sistema le permite conserve todos los registros médicos propios y de la familia en un solo lugar, donde estén ordenados y disponibles en línea. Ver \textbf{Figura \ref{carga_miembro}}. 
	...
	\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-carga_miembro}
...
Si necesitáramos cargar algún tipo de estudio específico de imágenes médicas(de formatos específicos y mayor tamaño) se debe realizar a través de Microsoft Connection Center, una aplicación de escritorio para Windows. Como un punto flaco, Health Vault, no nos permite asociar los documentos a otra información que ya tengamos en el sistema, simplemente podemos adjuntarle una nota.
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-carga_documento}
...
\item \textbf{Generación de reportes}: El sistema ofrece la posibilidad de generar una ficha de emergencia con información básica y esencial sobre el paciente para de este modo poder organizar y proporcionar este tipo de información al médico. Permite entre otras cosas:
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-tarjeta_bolsillo}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-graficas}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-lista_de_cambios}
...
Esto es importante para realizar un seguimiento sobre determinadas actividades físicas, o sobre aspectos de la salud donde es necesaria su medición continua. Conociendo estos valor podremos realizar modificaciones con fundamentos para aumentar la eficacia de nuestros esfuerzos y nuestra calidad de vida.
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-conexion_con_dispositivo}
...
%		\item No posee una sección de médicos o alguna forma de interacción con ellos (salvo la de carga de información). 
	...
	\begin{figure} 
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-compartir_perfil}
    ...
    \begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/3-cambiar_permisos}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/Login}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/PantallaPrincip}
...
\begin{figure}[h]
      \centering
      \includegraphics[height=.5\textheight]{img/tp1/HE/MenuHC}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/ConsultaDia}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/PedidoMedico}
...
\begin{figure}
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/Receta}
...
\begin{figure}
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/Practica1}
...
\begin{figure}[ht]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/HCMDmanualdigital}
...
\begin{figure}[h]
      ...
      \begin{subfigure}[t]{1\textwidth}
        \includegraphics[width=1\textwidth]{img/tp1/HE/HCUD2}
        \caption{Creación de historia clínica.}
        \label{hc-nueva}
      \end{subfigure}
      \hfill%
      \begin{subfigure}[t]{1\textwidth}
        \includegraphics[width=1\textwidth]{img/tp1/HE/Imagenes}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/HCUDConsulta}
...
\begin{figure}[h]
      \centering
      \includegraphics[width=1\textwidth]{img/tp1/HE/PlantillaPM}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{img/tp1/HCHEModeloFuncional}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{img/tp1/CDR}
...
\begin{figure}
  \centering
  \includegraphics[width=1\textwidth]{img/tp1/CDR-HCE}
